...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TcProjectService.ProjectRequestBody();
  });
  ...
  describe('ProjectRequestBody', function() {
    it('should create an instance of ProjectRequestBody', function() {
      // uncomment below and update the code to test ProjectRequestBody
      //var instane = new TcProjectService.ProjectRequestBody();
      //expect(instance).to.be.a(TcProjectService.ProjectRequestBody);
    });
